package org.hopeframework.utils.sign;
...
public class HmacSha1Util {
	...
	public static String creatAccessId(String phone) {
		return StringLocalUtils.getRandom(phone);
	}
	...
	public static String creatAccessKey(String accessid) {
		return StringLocalUtils.encodeBase64String(StringLocalUtils.getRandom(accessid), "UTF-8");
	}
